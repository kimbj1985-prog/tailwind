      ...
      <div className="max-w-1550 gap-[60px] w-full mx-auto py-[50px] flex justify-between">
        ...
        <div className="flex-1 flex gap-[50px] font-kr leadin-[1.8]">
          <div className="flex-1">
            <h3 className="font-bold text-subtitle mb-5">주식회사 포랩코리아</h3>
            <div className="">
          ...
          <div className="flex-1">
            <h3 className="font-bold text-subtitle mb-5" >고객센터</h3>
            <div>
            ...
            <h3 className="font-bold text-subtitle mb-5" >BANK INFO</h3>
          </div>
          <div className="flex-1 font-en">
            <h3 className="font-bold text-subtitle mb-5">help</h3>
          </div>
