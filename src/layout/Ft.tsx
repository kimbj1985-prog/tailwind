  ...
  return (
    <footer className="ft border-t-2 font-300 mt-[100px]">
      <div className="max-w-1550 gap-[60px] w-full mx-auto py-[50px] flex justify-between">
        ...
        <div className="flex-1 flex gap-[50px] font-kr leadin-[1.8]">
          <div className="flex-1">
            <h3 className="font-bold text-subtitle mb-3">주식회사 포랩코리아</h3>
            <div className="">
              ...
              <span className="font-medium">주소 : </span> 04056 서울 마포구 신촌로4길 22-8 4층 (동교동)<br />
              <span className="font-medium">개인정보관리책임자 : </span> 서인석
            </div>
            <ul className="flex leading-[0.8] mt-10 font-500">
              <li className="border-r-[1px]"><a href="" className="px-2">회사소개</a></li>
              <li className="border-r-[1px]"><a href="" className="px-2">약관</a></li>
              <li className="border-r-[1px]"><a href="" className="px-2">개인정보정책</a></li>
              <li><a href="" className="px-2">이용안내</a></li>              
            </ul>
          </div>
          <div className="flex-1">
            <h3 className="font-bold text-subtitle mb-3" >고객센터</h3>
            <div>
              <span className="font-medium">전화</span> 070-4800-3250 평일 10:00~17:00<br />
              Break Time - 12:30~13:30 (주말, 공휴일 휴무)<br />
              hyeongwon@fourlab.co.kr
            
            </div>

            <h3 className="font-bold text-subtitle mb-3 mt-10" >BANK INFO</h3>
            <div>
              국민은행<br />
              032901-04-366203<br />
              예금주 : 주식회사 포랩코리아
          ...
          <div className="flex-1 font-en flex flex-col">
            <h3 className="font-bold text-subtitle mb-3">HELP</h3>
          <div>
            <ul>
              <li>
              ...
              <li>
                <Link to="/store">1:1 문의</Link>
              </li>
              <li>
                <Link to="/store">입점 / 제휴문의</Link>
              </li>
            </ul>
          </div>
            ...
            <div className="sns family mt-auto flex justify-between">
              <div className="snslist flex gap-4 items-end">
                <a href="" className="bg-black p-3 rounded-full">
                <img src="/instar.svg" className="w-[24px]"></img>
                </a>
                <a href="" className="bg-black p-3 rounded-full">
              ...
              <div className="familySite relative">
                ...
                { !plusarrow &&
                <div className="familyList border bg-white rounded-[30px]px-4 py-5 
